...
const commands = {
  ...
  start: () => import('../cli/microsite-start').then(({ default: cmd }) => cmd),
...
`)
    ...
    switch (command) {
      case 'dev': return import('../cli/microsite-dev.js').then(({ default: cmd }) => cmd(argv))
      case 'start': return import('../cli/microsite-start.js').then(({ default: cmd }) => cmd(argv))
      case 'build': return import('../cli/microsite-build.js').then(({ default: cmd }) => cmd(argv))
    }
  }
}
