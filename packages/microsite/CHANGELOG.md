...
## 0.0.0-canary-2020101825812

### Patch Changes

- 01e921b: Microsite's partial hydration method manages each component as a seperate Preact tree, meaning standard `Context` won't work across components.
...
- cd879e7: Fix issue with CSS scoped name generation
